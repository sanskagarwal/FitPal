    ...
    <div className="flex items-center justify-center gap-2">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-gray-200 shadow-sm hover:border-primary-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
          aria-haspopup="dialog"
          aria-expanded={pickerOpen}
          title="Pick a date"
        >
          <Calendar className="w-4 h-4 text-primary-600" />
          <span className="text-sm font-semibold text-gray-800 min-w-[5.5rem] text-center">
      ...
      {!isToday && (
        <button
          onClick={goToToday}
          className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium text-primary-700 bg-primary-50 hover:bg-primary-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
          title="Jump to today"
        >
