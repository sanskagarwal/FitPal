        ...
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-900">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Weight</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">BMI</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Body Fat</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Notes</th>
              ...
              <tr key={entry.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                {editingId === entry.id ? (
                  <>
                    ...
                    <td className="px-4 py-3 text-sm">
                      <input
                        ...
                        className="w-20 px-2 py-1 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded"
                        autoFocus
                    ...
                    <td className="px-4 py-3 text-sm">
                      <input
                        ...
                        onKeyDown={editKeyHandler(entry.id)}
                        className="w-32 px-2 py-1 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded"
                        placeholder="Notes"
                  ...
                  <>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{entry.notes || '-'}</td>
                    <td className="px-4 py-3 text-sm">
                      <div className="flex gap-2">
                        <button
