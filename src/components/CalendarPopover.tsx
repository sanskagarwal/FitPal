    ...
    >
      ...
      <div className="mb-2 flex items-center justify-between">
        <button
          ...
          className="inline-flex items-center justify-center min-h-11 min-w-11 rounded-lg text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
        ...
        <button
          ...
          className="inline-flex items-center justify-center min-h-11 min-w-11 rounded-lg text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 enabled:active:scale-95 disabled:opacity-30 disabled:hover:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
        ...
        {days.map((day, i) => {
          ...
          return (
            <button
              ...
              className={`relative flex h-11 items-center justify-center rounded-lg text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 enabled:active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 ${tone} ${
